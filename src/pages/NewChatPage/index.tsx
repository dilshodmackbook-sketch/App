...
function NewChatPage({ref}: NewChatPageProps) {
    ...
    const toggleOption = (option: ListItem & Partial<OptionData>) => {
        // Read membership from the selection state (not the item) so rapid toggles stay correct while
        // the deferred list update below is still catching up to a previous press.
